const HomeIcon = ({size}) => {
  return (
    <svg role="img" height={size} width={size} class="Svg-ytk21e-0 jAKAlG home-active-icon" viewBox="0 0 24 24">
      <path 
...
const SearchIcon = ({size}) => {
  return (
    <svg role="img" height="24" width="24" class="Svg-ytk21e-0 jAKAlG search-icon" viewBox="0 0 24 24">
...
const CollectionIcon = ({size}) => {
  return (
    <svg role="img" height="24" width="24" class="Svg-ytk21e-0 jAKAlG collection-icon" viewBox="0 0 24 24">
...
const PlusIcon = ({size}) => {
  return(
    <svg role="img" height="12" width="12" aria-hidden="true" viewBox="0 0 16 16" class="Svg-ytk21e-0 jAKAlG">
...
const BookMarkIcon = ({size}) => {
  return (
    <svg role="img" height="12" width="12" aria-hidden="true" viewBox="0 0 16 16" class="Svg-ytk21e-0 jAKAlG">
      <path d="M3.75 0A1.75 1.75 0 002 1.75v12.952c0 1.051 1.22 1.633 2.037.972l3.962-3.208 3.943 3.204c.817.663 2.038.082 2.038-.97V1.75A1.75 1.75 0 0012.23 0H3.75z" fill="currentColor" />
    </svg>
  )
}
...
const DownloadIcon = ({size}) => {
  return (
    <svg role="img" height="24" width="24" viewBox="0 0 24 24" class="Svg-ytk21e-0 jAKAlG">
...
const PrevIcon = ({size}) => {
  return (
    <svg role="img" height="24" width="24" class="Svg-ytk21e-0 gFcOie IYDlXmBmmUKHveMzIPCF" viewBox="0 0 24 24">
...
const DownDir = ({size}) => {
  return (
    <svg role="img" height="16" width="16" class="Svg-ytk21e-0 jAKAlG eAXFT6yvz37fvS1lmt6k" viewBox="0 0 16 16">
